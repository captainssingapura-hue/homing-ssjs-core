...
public final class ComposedWidget extends DocWidget<ComposedWidget.Params, ComposedWidget> {
    ...
    protected List<String> bodyJs() {
        return List.of(
                ...
                "        // Leveled tree-path locator (RFC 0040) — no uuid; fetch the",
                "        // doc bytes positionally from /open-content (same path the",
                "        // Navigator's Open used). The uuid branch above still works.",
                "        var pq = [];",
                ...
                "    var ownerLabel = params.id || params.url || fetchUrl;",
                ...
                "    var stackEntry = params.id || params.url || fetchUrl;",
