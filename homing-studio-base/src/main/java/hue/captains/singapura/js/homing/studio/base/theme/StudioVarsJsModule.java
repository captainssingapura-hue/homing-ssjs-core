...
/**
 * Typed-color bridge: emits a JS module exporting every {@link HomingVars}
 ...
 *
 * <p>Single source of truth: {@link HomingVars}. The {@code selfContent}
 * body is generated reflectively from the public static {@link CssVar}
 * fields, so adding a token to {@link HomingVars} only requires adding
