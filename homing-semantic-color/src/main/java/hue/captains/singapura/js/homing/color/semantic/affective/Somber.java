...
/** Low valence, low arousal — subdued and heavy. */
public record Somber() implements SemanticColor, Leaf<Affective>, WithDesc {

    public static final Somber INSTANCE = new Somber();

    @Override public String name() { return "somber"; }
    @Override public Affective parent() { return Affective.INSTANCE; }
    @Override public Desc desc() { return Descs.of("Low valence, low arousal — subdued and heavy."); }
}
