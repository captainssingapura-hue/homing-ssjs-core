...
**Latest release: [0.6.1 — Two-Way Docs, Articulated Tables](https://github.com/captainssingapura-hue/japjs/releases/tag/0.6.1).** ([full notes](release-notes/0_6_1.md)) The rigid-doc viewer now syncs **both ways** — scroll the body and the table of contents follows (an `IntersectionObserver` scroll-spy plus a widget-local Secretary that dissolves the click-vs-scroll loop), while arrow keys always drive the TOC, never the scrollbar. **Relations gain per-cell articulation**: `.articulatedRelation(...)` with `cell("…").success()/.right()/.strong()` attaches a status-colour / alignment / emphasis side-car that rides parallel to the plain rows and is emitted only when present. Two fixes land too — **embedded SVG / image / table now render in rigid-tree docs** (the missing `/doc-tree-content` route is wired), and **a spawned widget remembers its pane** across a refresh (Defect 0007). No breaking changes — everything is additive.

Past releases: [0.6.0 — HTTPS, and Diagrams As Text](https://github.com/captainssingapura-hue/japjs/releases/tag/0.6.0) · [0.5.4 — Bring Your Own Tree, Typed](https://github.com/captainssingapura-hue/japjs/releases/tag/0.5.4) · [0.5.3 — Typed Blocks, Trees On Demand](https://github.com/captainssingapura-hue/japjs/releases/tag/0.5.3) · [0.5.2 — Legacy Markdown, Live](https://github.com/captainssingapura-hue/japjs/releases/tag/0.5.2) · [0.5.1 — The Document Pane](https://github.com/captainssingapura-hue/japjs/releases/tag/0.5.1) · [0.5.0 — The Rigid-Tree Document](https://github.com/captainssingapura-hue/japjs/releases/tag/0.5.0) · [0.4.0 — The Workspace Becomes a Product](https://github.com/captainssingapura-hue/japjs/releases/tag/0.4.0) · [0.3.0 — The Workspace Substrate](https://github.com/captainssingapura-hue/japjs/releases/tag/0.3.0) · [0.2.0 — Workspace Primitives](https://github.com/captainssingapura-hue/japjs/releases/tag/0.2.0) · [0.1.0 — The Widget Substrate](https://github.com/captainssingapura-hue/japjs/releases/tag/0.1.0). Full notes under [`release-notes/`](release-notes/).
