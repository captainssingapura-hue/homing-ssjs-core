 ...
 * {@link Pairing}, {@link Spacing}, {@link Brand}, {@link Structure}); a
 ...
 * it — {@code Feedback.Danger.Color_Surface} — so a projection exists once,
 * where the meaning lives, and a consumer can only ask for one that exists.</p>
 *
 ...
 * exactly one branch, and a leaf's projections are declared inside it.</p>
 */
