 ...
 * complete by construction. The house colours are the first set; Forest and
 * Sunset are two more, and they colour any physique.
 *
 * <p>Feedback — danger, success, warning — is the same in every seed
 * palette: a signal is a signal whatever the brand.</p>
 *
 * @param slug        the palette's slug, and the suffix of every cross that wears it
 ...
 */
public record SeedPalette(String slug, String label, String inspiration, Seeds light, Seeds dark) implements Palette {
    ...
    /** The house colours — navy, gold, a cool white page. */
    public static final SeedPalette HOUSE = new SeedPalette("default", "Default",
            "The house identity — navy and gold on a cool white page.",
    ...
    /** Green and earth, with honey for the accents. */
    public static final SeedPalette FOREST = new SeedPalette("forest", "Forest",
            "Green and earth tones, with honey for the accents.",
    ...
    /** Warm coral and terracotta — a dusk palette. */
    ...
    @Override public Impl impl(DesignClass<?> pair) {
        return pair.onColourPlane() ? WORDS.computeIfAbsent(slug, s -> words()).get(pair) : null;
    }
