...
final class NeoFuturismDesign {
    ...
    static final Map<DesignClass<?>, Impl> WORDS = Map.ofEntries(
            ...
            body(of(Prose.class, Color.Ink.class), """
                ...
                th { color: %s; }
                """.formatted(TEXT, TEXT, CYAN_INK, VIOLET, MUTED, VIOLET, ON_INVERTED, CYAN_INK)),
