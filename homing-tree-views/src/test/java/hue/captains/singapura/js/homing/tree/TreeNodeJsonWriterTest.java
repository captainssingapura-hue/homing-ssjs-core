...
class TreeNodeJsonWriterTest {
    ...
    private static Map<DimensionKey, DimensionValue> dims(String label) {
    ...
    @Test
    void leafRoundTrip() {
        var leaf = new L1Node(seg("alpha"), dims("Alpha"), List.of());
    ...
    void nestedTwoLevels() {
        var leafA = new L1Node(seg("alpha"), dims("Alpha"), List.of());
        var leafB = new L1Node(seg("beta"),  dims("Beta"), List.of());
        var root  = new L0Node(seg("root"),  dims("Root"), List.of(leafA, leafB));
